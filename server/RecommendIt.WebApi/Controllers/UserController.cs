...
namespace GeoTagMap.WebApi.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> PutAsync(Guid id, [FromBody] UserModelRest userRest, bool isChangeToAdmin = false)
        {
            try
            {
                IUserModel user = MapUser(userRest);
                ...
                await _userService.UpdateUserAsync(id, user, isChangeToAdmin, userRest.OldPassword);
