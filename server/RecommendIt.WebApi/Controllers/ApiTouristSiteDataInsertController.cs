            ...
            if (existingTouristSite == null)
            {
                using (var scope = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                {
                    ...
                    foreach (var categoryData in venue.Categories)
                    {
                        ...
                        ITouristSiteCategoryModel existingTouristSiteCategory = await _touristSiteCategoryService.GetTouristSiteCategoryByCategoryAndTouristSiteIdAsync(category.Id, touristSite.Id);
                        if (existingTouristSiteCategory == null) { 
