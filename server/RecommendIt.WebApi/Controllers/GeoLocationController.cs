    ...
    public class GeoLocationController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> GetAsync(Guid id)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.NoContent, "No GeoLocation with that Id");
                }
        ...
        [HttpGet]
        [Authorize(Roles = "Admin")]
        [Route("locationid/{id:guid}")]
        public async Task<HttpResponseMessage> GetByLocationIdAsync(Guid id)
        {
            try
            {
                var geoLocation = await _geoLocationService.GetGeoLocationByLocationIdAsync(id);
                if (geoLocation is null)
                {
                    return Request.CreateResponse(HttpStatusCode.NoContent, "No GeoLocation with that Id");
                }
