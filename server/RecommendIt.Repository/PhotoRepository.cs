        ...
        public async Task<List<IPhotoModel>> GetPhotosAsync()
        {
            ...
            using (var con = new NpgsqlConnection(_connectionString))
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    query.Append("SELECT p.\"Id\", p.\"ImageData\", p.\"ImagePrefix\", p.\"ImageSuffix\", p.\"TouristSiteId\" AS PhotoTouristSiteId, p.\"StoryId\" AS PhotoStoryId, p.\"UserId\" AS PhotoUserId, p.\"DateCreated\", p.\"DateUpdated\", p.\"CreatedBy\", ");
        ...
        public async Task<List<IPhotoModel>> GetPhotosByTouristSiteIdAsync(Guid touristSiteId)
        {
            ...
            using (var con = new NpgsqlConnection(_connectionString))
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    query.Append("LEFT JOIN \"User\" u ON p.\"UserId\" = u.\"Id\" ");
                    query.Append("WHERE p.\"IsActive\" = true ");
                    query.Append("AND p.\"TouristSiteId\" = @touristSiteId");
        ...
        public async Task<List<IPhotoModel>> GetPhotosByStoryIdAsync(Guid storyId)
        {
            ...
            using (var con = new NpgsqlConnection(_connectionString))
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    query.Append("LEFT JOIN \"User\" u ON p.\"UserId\" = u.\"Id\" ");
                    query.Append("WHERE p.\"IsActive\" = true ");
                    query.Append("AND p.\"StoryId\" = @storyId");
        ...
        public async Task AddPhotoAsync(IPhotoModel photoModel)
        {
            using (var con = new NpgsqlConnection(_connectionString))
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    StringBuilder query = new StringBuilder();
                    query.Append("INSERT INTO \"Photo\" (\"Id\", \"ImageData\", \"ImagePrefix\", \"ImageSuffix\", \"TouristSiteId\", \"StoryId\", \"UserId\", \"DateCreated\", \"DateUpdated\", \"CreatedBy\", \"UpdatedBy\", \"IsActive\") ");
                    query.Append("VALUES (@id, @imageData, @imagePrefix, @imageSuffix, @touristSiteId, @storyId, @userId, @dateCreated, @dateUpdated, @createdBy, @updatedBy, @isActive)");

                    cmd.CommandText = query.ToString();

                    cmd.Parameters.AddWithValue("@id", photoModel.Id);
                    cmd.Parameters.AddWithValue("@imageData", photoModel.ImageData ?? (object)DBNull.Value);
